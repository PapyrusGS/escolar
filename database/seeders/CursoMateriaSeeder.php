...
class CursoMateriaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('cursos_materias')->insert([
            ...
            // --- Secciones extra para primer semestre (sin prerrequisitos) ---
            ['IdCurso' => 5,  'IdMateria' => 1, 'IdDocente' => 5,  'IdTurno' => 2, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 35, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
            ['IdCurso' => 6,  'IdMateria' => 2, 'IdDocente' => 15, 'IdTurno' => 1, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 30, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
            ['IdCurso' => 7,  'IdMateria' => 3, 'IdDocente' => 16, 'IdTurno' => 2, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 35, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
            ['IdCurso' => 8,  'IdMateria' => 4, 'IdDocente' => 2,  'IdTurno' => 1, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 40, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
            ['IdCurso' => 9,  'IdMateria' => 5, 'IdDocente' => 5,  'IdTurno' => 2, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 30, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
            ['IdCurso' => 10, 'IdMateria' => 6, 'IdDocente' => 15, 'IdTurno' => 1, 'FechaInicio' => $hoy->copy()->toDateString(),  'FechaFin' => $hoy->copy()->addDays(30)->toDateString(), 'MaxInscritos' => 35, 'Inscritos' => 0, 'FechaRegistro' => now(), 'Estado' => true],
        ]);
    }
}
